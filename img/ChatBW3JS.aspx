...
function isTel(a)
{
   ...
   var isPhone = /^0([0-9]{2,3}-|[1-9]{2,3})?[0-9]{7,8}$/;
    var isMob=/^((\+?86)|(\(\+86\)))?(1[345789][0123456789][0-9]{8})$/;
...
function start2(o) {
	...
	if (o[0] != "1") timerID_answermore = setTimeout("autoanswermore()", 1e3);
        if (typeof (Xststartchat) != 'undefined')
                    Xststartchat();
}
	...
	for (w = 0; w < rr.length; w++) {
		...
		if (o[3] != "") {
			...
			case "-3":
				...
				f20(o[1], 3, o[5] + "&nbsp; " + o[0], true);_oname = o[5];
				play();
				break;
...
function User_Send(e) {
	...
	f19("", false);
	f7();
	if(typeof(XstSendmsg)!='undefined')XstSendmsg(tempouttext);
	if (newtext != "") {
