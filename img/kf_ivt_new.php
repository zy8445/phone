	...
	function hz6d_cus_web_msg_open(){
		var openurl = "https://www58.53kf.com/webCompany.php?kf_sign=DM2ODMTU1NU0OTEwOTc3Njg0OTczMDA4NzIxNDE1NzE=&arg=10141571&style=1&kflist=off&kf=s448761%40163.com%2Cs448762%40163.com%2Ca1407422%40163.com&zdkf_type=1&lnk_overflow=0&language=zh-cn&charset=gbk&username=&userinfo=&introurl=&lyurl=&lytype=0&copartner=&referer=http%3A%2F%2Fm.boyue1314.com%2Fhtml%2Fbrand%2F&keyword=http%3A%2F%2Fm.boyue1314.com%2F%3Fgtmzhjjllc1%26sg063479%24Hun%2ASha%2AZhao%2AYi%2ABan%2ADuo%2AShao%2AQian&brief=&logo=&question=&uid=9ca4449e3def9eacd8adf4a31e07fecd";
		try{
...
//	hz6d_get_guest_id_timer = setTimeout("hz6d_get_guest_id()", 500);
	...
	var create_flp_jquery_timer = window.setInterval(function(){
		if (!document.getElementById('hz6d_flp_jquery')) {
			$53.creElm({
				id: 'hz6d_flp_jquery',
				src: 'https://www58.53kf.com/minkh/js/jquery-1.4.2.flp.js?20121127002',
				charset: "utf-8",
...
///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
            ...
            var ivt_autotype           = "0";
			var zdyivt						= "0";
			var ivtstr						= "<div id=\"acc_title\" class=\"Lelem\" minheight=\"100\" minwidth=\"100\" maxheight=\"400\" maxwidth=\"400\" style=\"    position: relative; z-index: 10000;\"><div class=\"Lelem\" type=\"img\" style=\"display: block; cursor: default; position: absolute; top: 51px; left: 10px; z-index: 10001; width: 394px; height: 242px;\"><img style=\"width: 394px; height: 242px;\" src=\"https://www58.53kf.com/style/setting/ver06/img/icon/logo-skin/common_bg_inv/commonbg_1.png\"></div><div style=\"display: block; cursor: default; position: absolute; top: 58px; left: 10px; z-index: 10002; width: 227px; height: 21px; color: rgb(255, 255, 255);\" type=\"text\" class=\"Lelem\" operating=\" \"><span style=\"vertical-align: top; font-size: 14.7px; line-height: 21px; color: rgb(255, 255, 255); font-family: 宋体; font-weight: bold;\" iseditable=\"1\">铂悦婚纱·全球蜜月旅拍</span></div><div style=\"display: block; cursor: pointer; position: absolute; top: 58px; left: 365px; z-index: 10003; width: 22px; height: 22px;\" operating=\"CLOSE\" type=\"img\" class=\"Lelem\"><img src=\"https://www58.53kf.com/style/setting/ver06/img/icon/logo-skin/close_btn/closebtn_1.png\" style=\"width: 22px; height: 22px;\"></div><div style=\"display: block; cursor: default; position: absolute; top: 98px; left: 18px; z-index: 10004; width: 134px; height: 145px;\" type=\"img\" class=\"Lelem\"><img src=\"https://www58.53kf.com/style/setting/ver06/img/icon/logo-skin/other_img/otherimg_11.png\" style=\"width: 134px; height: 145px;\"></div><div style=\"display: block; cursor: default; position: absolute; top: 91px; left: 165px; z-index: 10005; width: 147px; height: 49px;\" type=\"text\" class=\"Lelem\"><span style=\"vertical-align: top; font-size: 34.3px; line-height: 49px; color: rgb(58, 50, 45); font-family: 黑体;\" iseditable=\"1\">欢迎咨询</span></div><div style=\"display: block; cursor: default; position: absolute; top: 141px; left: 173px; z-index: 10006; width: 210px; height: 17px;\" type=\"text\" class=\"Lelem\"><span style=\"vertical-align: top; font-size: 12px; line-height: 17px; font-family: 宋体;\" iseditable=\"1\">铂悦婚纱·全球蜜月旅拍客服，感谢大家的支持！</span></div><div style=\"display: block; cursor: default; position: absolute; top: 158px; left: 230px; z-index: 10007; width: 178px; height: 17px;\" type=\"text\" class=\"Lelem\"><span style=\"vertical-align: top; font-size: 12px; line-height: 17px; font-family: 宋体;\" iseditable=\"1\">请问有什么可以帮您？</span></div><div class=\"Lelem\" type=\"img\" operating=\"KF\" style=\"display: block; cursor: pointer; position: absolute; top: 199px; left: 173px; z-index: 10008; width: 122px; height: 35px;\"><img style=\"width: 122px; height: 35px;\" src=\"https://www58.53kf.com/style/setting/ver06/img/icon/logo-skin/click_btn/clickbtn_81.png\"></div></div>";
			var is_autoyqk				= "1";
		...
		//	var acc_poptype			 = -1;
			...
			var pc_ivt_top = "40";
			var pc_ivt_left = "50";
			var callback_id6ds = "10202453,10202455,10258888";
			...
			if ((pc_ivt_type == '2' || pc_ivt_type == '-1') && 0 == '0') {
				...
				if(1 == 1){
					btn_style1 = 'background: center center no-repeat;background-image: url(https://www58.53kf.com/style/chat/new2017/image/png/img-info24.png);background-image: url(https://www58.53kf.com/style/chat/new2017/image/svg/img-info24.svg), none;'
					btn_style2 = 'position: relative;height: 100%;width: 100%;background: center center no-repeat;background-color: '+minicolor_tbbj+';background-image: url(https://www58.53kf.com/style/chat/new2017/image/png/img-info36.png);background-image: url(https://www58.53kf.com/style/chat/new2017/image/svg/img-info36.svg), none;'
				}else {
					btn_style1 = 'background: center center no-repeat;background-image: url(https://www58.53kf.com/style/chat/new2017/image/png/img-email24.png);background-image: url(https://www58.53kf.com/style/chat/new2017/image/svg/img-email24.svg), none;'
					btn_style2 = 'position: relative;height: 100%;width: 100%;background: center center no-repeat;background-color: '+minicolor_tbbj+';background-image: url(https://www58.53kf.com/style/chat/new2017/image/png/img-email36.png);background-image: url(https://www58.53kf.com/style/chat/new2017/image/svg/img-email36.svg), none;'
				...
				if(mini_style_type==1){
					bubble_html = '<div class="mini-btn mini-btn1" id="mini-btn" onclick="show_floatWindow();" style="width:auto;white-space:nowrap;cursor:pointer;'+mini_btn_display+'position:absolute;'+mini_button_position+'z-index:-1;height: 42px;border-radius:2px; overflow: hidden; background: '+minicolor_tbbj+';-webkit-box-shadow: 0 1px 6px rgba(0, 0, 0, .06), 0 2px 32px rgba(0, 0, 0, .16)!important;box-shadow: 0 1px 6px rgba(0, 0, 0, .06), 0 2px 32px rgba(0, 0, 0, .16)!important;">'+
										...
										'<div class="mini-btn-window" style="display:inline-block;width: 42px;height: 42px;background: center center no-repeat;background-image: url(https://www58.53kf.com/style/chat/new2017/image/png/to-maxWindow.png);background-image: url(https://www58.53kf.com/style/chat/new2017/image/svg/to-maxWindow.svg), none;"></div>'+
									'</div>';
				...
				tmp_innerHTML += '<div id="iframe_company_mini_div" style="'+mini_div_display+'font-size: 0;background-color:#fff;border-radius:2px;overflow:hidden;width:100%;height:'+mini_size_height+'px;box-shadow:0 5px 40px rgba(0,0,0,.16)!important;-webkit-box-shadow:0 5px 40px rgba(0,0,0,.16)!important;">'+
									'<h6 class="pc-visitor-header" style="width:100%;box-sizing:border-box;background: '+minicolor_tbbj+' no-repeat 10px;margin:0;padding:0;padding-left: 42px;font-size: 14px;color: #fff;height: 36px;line-height: 36px;position: relative;font-weight: normal;padding-right: 72px;">'+
										'<img style="width:24px;height:24px;position:absolute;left:10px;top:6px;border-radius:2px;" src="https://www58.53kf.com/img/upload/10141571/mobile/temp/mobile_53kf_1550561203.jpg"/>'+
	...
	//↑↑↑↑↑↑↑↑↑↑↑↑↑↑↑↑↑↑↑↑↑↑↑↑↑↑  2017版访客端新增 ↑↑↑↑↑↑↑↑↑↑↑↑↑↑↑↑↑↑↑↑↑↑↑↑
			...
			function cgpic(t){
				if( $53("div_company_mini").style.width =="400px"){
					document.querySelector('.mini_narrow').style.background="url('https://www58.53kf.com/style/chat/minichat2/img/minx1.png') no-repeat";
				}

			}
			function cgpic2(t){
				if( $53("div_company_mini").style.width =="400px"){
					document.querySelector('.mini_narrow').style.background="url('https://www58.53kf.com/style/chat/minichat2/img/minx2.png') no-repeat";
				}
			}
			function cgpic3(t){
				document.querySelector('.mini_maxto').style.background="url('https://www58.53kf.com/style/chat/minichat2/img/double1.png') no-repeat";
			}
			function cgpic4(t){
				document.querySelector('.mini_maxto').style.background="url('https://www58.53kf.com/style/chat/minichat2/img/double2.png') no-repeat";
			}
			function cgpic5(t){
				document.querySelector('.mini_close').style.background="url('https://www58.53kf.com/style/chat/minichat2/img/close1.png') no-repeat 50% 50%";
			}
			function cgpic6(t){
				document.querySelector('.mini_close').style.background="url('https://www58.53kf.com/style/chat/minichat2/img/close2.png') no-repeat 50% 50%";
			}
			...
			function max_min_company_mini(t)
			{
				if (t.getAttribute('max_min') == 'max')
				{
					...
					t.style.backgroundImage = "url('https://www58.53kf.com/style/chat/minichat2/img/max.png')";
					t.setAttribute('max_min','min');
					t.title = t.getAttribute('mini_recover');
                    $53("div_company_mini").style.right = '0px';
			     	$53("div_company_mini").style.bottom = '0px';                    $53("mini_header_bg_div").style.backgroundImage = "url('https://www58.53kf.com/style/chat/minichat2/img/header_bg2_6.png')";
				}
				else
				{
					...
					t.style.backgroundImage = "url('https://www58.53kf.com/style/chat/minichat2/img/min.png')";
				...
				}                   $53("mini_header_bg_div").style.backgroundImage = "url('https://www58.53kf.com/style/chat/minichat2/img/header_bg_6.png')";
			...
			{
				if(zdfq_switch == 'yes') {
					//document.cookie = "onliner_zdfq72141571="+onliner_zdfq;
					document.cookie = "my_acc_reauto_time=" + new Date().getTime() + ";path=/";
				} else {
					document.cookie = "my_acc_reauto_time=null;path=/";
				}
...
///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
				...
				try{
					...
					if(type==1){
						...
						if('1' == 0){
							...
							$53("iframe_company_mini").src = openurl_mini + tpl + '&timeStamp=' + new Date().getTime()+'&interface_color=6&interface_theme=1&minchat_style=1';
   ...
   //                  onliner_zdfq = 0;
			// 	}
   //              if(acc_autotype == 3) {onliner_zdfq = 3;document.cookie = "onliner_zdfq72141571="+onliner_zdfq;}
					...
					if(vals[1])
					{
						...
						switch(valst[0])
						{
							case 'KF':
								...
								break;
								//click_str ='onliner_zdfq=2;get_open_start();window.open(\"https://www58.53kf.com/webCompany.php?kf_sign=DM2ODMTU1NU0OTEwOTc3Njg0OTczMDA4NzIxNDE1NzE=&arg=10141571&style=1&kflist=off&kf=s448761%40163.com%2Cs448762%40163.com%2Ca1407422%40163.com&zdkf_type=1&lnk_overflow=0&language=zh-cn&charset=gbk&username=&userinfo=&introurl=&lyurl=&lytype=0&copartner=&referer=http%3A%2F%2Fm.boyue1314.com%2Fhtml%2Fbrand%2F&keyword=http%3A%2F%2Fm.boyue1314.com%2F%3Fgtmzhjjllc1%26sg063479%24Hun%2ASha%2AZhao%2AYi%2ABan%2ADuo%2AShao%2AQian&brief=&logo=&question=&uid=9ca4449e3def9eacd8adf4a31e07fecd&tfrom=2\",\"_blank\",\"height=473,width=703,top=200,left=200,status=yes,toolbar=no,menubar=no,resizable=yes,scrollbars=no,location=no,titlebar=no\");hidden_ivt();';break;
							case 'CLOSE':
								click_str = 'onliner_zdfq=3;jtfq_type=1;hidden_ivt();'; break;
							case 'ETEL':
								click_str = 'window.open(\'https://tb.53kf.com/eht.php?company_id=72141571&style_id=106187870\',\'_blank\',\'height=400,width=300,top=100,left=200,status=yes,toolbar=no,menubar=no,resizable=no,scrollbars=no,location=no,titlebar=no\')';break;
							case 'QQ':
								if(valst[1]){
									if(valst[1].toLowerCase().indexOf('biz') > -1){
										var qq = valst[1].replace('biz','');
										link_str = 'https://www58.53kf.com/bizqq.php?qq=' + qq + '&from=' + window.encodeURIComponent(window.location.href);
									}else{
